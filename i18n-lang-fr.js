...
cty_global:'Mondial', cty_om:'Oman', cty_ae:'Émirats arabes unis', cty_sa:'Arabie saoudite', cty_us:'États-Unis', cty_uk:'Royaume-Uni', cty_jo:'Jordanie', cty_in:'Inde', cty_pk:'Pakistan', cty_bd:'Bangladesh', cty_eg:'Égypte', cty_ph:'Philippines', badge_privacy_full:'La plupart des outils fonctionnent localement dans votre navigateur', badge_count_full:'40+ outils et guides', export_img_btn:'📸 Exporter en image',
    ...
    discount_intro:'Outil gratuit avec deux modes : calculer un pourcentage d\'un nombre, ou calculer le prix après une remise donnée. Utile pour les achats, les offres promotionnelles et la comparaison des prix en supermarché et en ligne.',
    sal_intro:'Calculez instantanément votre salaire net à Oman — indiquez votre salaire de base et vos indemnités, les cotisations SPF sont calculées automatiquement. En 2026, aucun impôt sur le revenu des personnes physiques ne s\'applique aux salaires (loi PIT promulguée en 2025, application à partir de 2028) — la seule retenue pour les Omanais est de 8 % au titre du SPF.',
    vat_intro:'La TVA (taxe sur la valeur ajoutée) s\'applique dans les pays du Golfe. Oman a instauré une TVA de 5 % en avril 2021 sur la plupart des biens et services. Ce calculateur prend en charge 6 pays du CCG et vous permet d\'ajouter la TVA à un montant ou de l\'en extraire.',
    tip_intro:'Calculez le pourboire approprié et partagez l\'addition équitablement entre n\'importe quel nombre de personnes. Déplacez le curseur pour choisir un pourcentage de pourboire (0 % à 30 %) et indiquez le nombre de personnes pour obtenir instantanément la part de chacune.',
    tz_intro:'Consultez l\'heure actuelle en direct dans 6 grandes villes (Riyad, Dubaï, Londres, New York, Tokyo, Sydney) ou convertissez n\'importe quelle heure entre deux fuseaux parmi une liste de 20 villes mondiales.',
    word_intro:'Collez votre texte et les statistiques de mots, caractères et phrases apparaissent instantanément. Utile pour les auteurs, étudiants et blogueurs qui doivent respecter des limites de mots pour des articles, messages ou travaux de recherche.',
    pass_intro:'Cet outil utilise l\'API Web Crypto intégrée au navigateur pour générer un véritable hasard cryptographique — les mots de passe ne sont jamais stockés ni envoyés à un serveur. Choisissez la longueur et les types de caractères, puis cliquez pour copier instantanément.',
    ic_intro:'Compressez votre image directement dans le navigateur, sans téléchargement vers un serveur. Tout le traitement se fait sur votre appareil, garantissant une confidentialité totale. Prend en charge JPG, PNG et WebP — le gain peut atteindre 90 % selon l\'image et les réglages, avec un contrôle total du niveau de qualité.',
    qr_intro:'Générez un code QR pour n\'importe quel lien ou texte en quelques secondes. Téléchargez-le en PNG haute qualité. Idéal pour les liens de sites web, les numéros WhatsApp, les adresses e-mail et les cartes de visite.',
    ci_intro:'Les intérêts composés reposent sur le principe des « intérêts qui génèrent des intérêts » — les gains de votre investissement s\'ajoutent au capital et génèrent à leur tour de nouveaux gains. Cet effet cumulatif rend la différence entre épargner tôt et épargner tard considérable sur le long terme. Indiquez votre montant, le taux d\'intérêt et la durée pour voir la puissance des intérêts composés.',
    unit_intro:'Prend en charge trois types de conversion : longueur (mètre, kilomètre, pied, pouce, mile), poids (kilogramme, livre, gramme, tonne) et température (Celsius, Fahrenheit, Kelvin). La conversion est instantanée pendant la saisie.',
    hijri_intro:'Ce convertisseur permet de passer du calendrier islamique (hégirien) lunaire au calendrier grégorien solaire, et inversement, à l\'aide d\'un algorithme tabulaire du calendrier hégirien. Couramment utilisé pour trouver les dates d\'occasions islamiques comme le Ramadan et l\'Aïd al-Adha, et largement utilisé dans les pays du Golfe. Les résultats peuvent différer de 1 à 2 jours par rapport aux calendriers officiels basés sur l\'observation de la lune.',
    dd_intro:'Outil gratuit pour calculer la différence exacte entre deux dates en jours, semaines, mois, années et jours ouvrés approximatifs. Utile pour calculer la durée des contrats, les périodes de congé et le nombre de jours restants avant un événement.',
};

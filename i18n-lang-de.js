...
cty_global:'Global', cty_om:'Oman', cty_ae:'Vereinigte Arabische Emirate', cty_sa:'Saudi-Arabien', cty_us:'USA', cty_uk:'Vereinigtes Königreich', cty_jo:'Jordanien', cty_in:'Indien', cty_pk:'Pakistan', cty_bd:'Bangladesch', cty_eg:'Ägypten', cty_ph:'Philippinen', badge_privacy_full:'Die meisten Tools funktionieren lokal in Ihrem Browser', badge_count_full:'40+ Tools & Anleitungen', export_img_btn:'📸 Als Bild exportieren',
    ...
    discount_intro:'Kostenloses Tool mit zwei Modi: einen Prozentsatz einer Zahl berechnen oder den Preis nach einem bestimmten Rabatt berechnen. Nützlich beim Einkaufen, bei Rabattaktionen und beim Preisvergleich in Supermärkten und Online-Shops.',
    sal_intro:'Berechnen Sie sofort Ihr Nettogehalt in Oman — geben Sie Ihr Grundgehalt und Ihre Zulagen ein, die SPF-Beiträge werden automatisch berechnet. Im Jahr 2026 gilt keine Einkommensteuer auf Gehälter (PIT-Gesetz 2025 verabschiedet, Umsetzung ab 2028) — der einzige Abzug für Omaner ist 8% SPF.',
    vat_intro:'Die Mehrwertsteuer (VAT) wird in den Golfstaaten erhoben. Oman führte im April 2021 eine Mehrwertsteuer von 5% auf die meisten Waren und Dienstleistungen ein. Dieser Rechner unterstützt 6 GCC-Länder und ermöglicht es Ihnen, die Mehrwertsteuer zu einem Betrag hinzuzufügen oder aus ihm herauszurechnen.',
    tip_intro:'Berechnen Sie das passende Trinkgeld und teilen Sie die Rechnung gleichmäßig unter einer beliebigen Anzahl von Personen auf. Bewegen Sie den Schieberegler, um einen Trinkgeldprozentsatz (0 % bis 30 %) zu wählen, und geben Sie die Personenzahl ein, um sofort den Anteil jeder Person zu erhalten.',
    tz_intro:'Sehen Sie die aktuelle Uhrzeit live in 6 wichtigen Städten (Riad, Dubai, London, New York, Tokio, Sydney) oder rechnen Sie eine beliebige Uhrzeit zwischen zwei Zeitzonen aus einer Liste von 20 Weltstädten um.',
    word_intro:'Fügen Sie Ihren Text ein, und Statistiken zu Wörtern, Zeichen und Sätzen erscheinen sofort. Nützlich für Autoren, Studierende und Blogger, die Wortgrenzen für Artikel, Nachrichten oder wissenschaftliche Arbeiten einhalten müssen.',
    pass_intro:'Dieses Tool nutzt die im Browser integrierte Web-Crypto-API, um echte kryptografische Zufälligkeit zu erzeugen — Passwörter werden niemals gespeichert oder an einen Server gesendet. Wählen Sie die Länge und die Zeichentypen und klicken Sie zum sofortigen Kopieren.',
    ic_intro:'Komprimieren Sie Ihr Bild direkt im Browser, ohne es auf einen Server hochzuladen. Die gesamte Verarbeitung erfolgt auf Ihrem Gerät und garantiert vollständige Privatsphäre. Unterstützt JPG, PNG und WebP — die Einsparung kann je nach Bild und Einstellungen bis zu 90 % betragen, mit voller Kontrolle über die Qualitätsstufe.',
    qr_intro:'Erstellen Sie in Sekunden einen QR-Code für einen beliebigen Link oder Text. Laden Sie ihn als hochwertiges PNG herunter. Perfekt für Website-Links, WhatsApp-Nummern, E-Mail-Adressen und Visitenkarten.',
    ci_intro:'Zinseszins beruht auf dem Prinzip, dass „Zinsen Zinsen erzeugen" — die Erträge Ihrer Anlage werden dem Kapital hinzugefügt und erzeugen wiederum neue Erträge. Dieser kumulative Effekt macht den Unterschied zwischen frühem und spätem Sparen langfristig enorm. Geben Sie Betrag, Zinssatz und Laufzeit ein, um die Kraft des Zinseszinses zu sehen.',
    unit_intro:'Unterstützt drei Umrechnungsarten: Länge (Meter, Kilometer, Fuß, Zoll, Meile), Gewicht (Kilogramm, Pfund, Gramm, Tonne) und Temperatur (Celsius, Fahrenheit, Kelvin). Die Umrechnung erfolgt sofort während der Eingabe.',
    hijri_intro:'Dieser Konverter rechnet zwischen dem islamischen (Hijri) Mondkalender und dem gregorianischen Sonnenkalender um, unter Verwendung eines tabellarischen Hijri-Kalenderalgorithmus. Wird häufig verwendet, um Daten für islamische Anlässe wie Ramadan und Eid al-Adha zu finden, und ist in den Golfstaaten weit verbreitet. Die Ergebnisse können um 1–2 Tage von offiziellen, auf Mondsichtung basierenden Kalendern abweichen.',
    dd_intro:'Kostenloses Tool zur Berechnung der genauen Differenz zwischen zwei beliebigen Daten in Tagen, Wochen, Monaten, Jahren und ungefähren Arbeitstagen. Nützlich zur Berechnung von Vertragslaufzeiten, Urlaubszeiten und der verbleibenden Tage bis zu einem bevorstehenden Ereignis.',
};

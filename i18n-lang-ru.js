...
window.T.ru = {
    ...
    back:'← Назад на главную', footer_about:'О нас', footer_contact:'Контакт', footer_privacy:'Конфиденциальность', footer_terms:'Условия',
...
cty_global:'Глобально', cty_om:'Оман', cty_ae:'ОАЭ', cty_sa:'Саудовская Аравия', cty_us:'США', cty_uk:'Великобритания', cty_jo:'Иордания', cty_in:'Индия', cty_pk:'Пакистан', cty_bd:'Бангладеш', cty_eg:'Египет', cty_ph:'Филиппины', badge_privacy_full:'Большинство инструментов работают локально в вашем браузере', badge_count_full:'40+ инструментов и гидов', export_img_btn:'📸 Экспорт как изображение',
    ...
    tz_convert:'Конвертировать время', tz_from:'Из зоны', tz_to:'В зону', tz_input_lbl:'Введённое время', tz_result_lbl:'Пересчитанное время',
    ...
    discount_intro:'Бесплатный инструмент с двумя режимами: расчёт процента от числа или расчёт цены после указанной скидки. Полезен для покупок, распродаж и сравнения цен в супермаркетах и интернет-магазинах.',
    sal_intro:'Мгновенно рассчитайте свою чистую зарплату в Омане — введите базовый оклад и надбавки, взносы в SPF рассчитываются автоматически. В 2026 году подоходный налог с физических лиц на зарплаты не применяется (закон PIT принят в 2025 году, вступление в силу с 2028 года) — единственный вычет для граждан Омана — это 8% в SPF.',
    vat_intro:'НДС (налог на добавленную стоимость) применяется в странах Персидского залива. Оман ввёл НДС в размере 5% в апреле 2021 года на большинство товаров и услуг. Этот калькулятор поддерживает 6 стран ССАГПЗ и позволяет добавить НДС к любой сумме или выделить его из неё.',
    tip_intro:'Рассчитайте подходящие чаевые и разделите счёт поровну между любым количеством человек. Передвиньте ползунок, чтобы выбрать процент чаевых (от 0% до 30%), и укажите количество людей, чтобы мгновенно узнать долю каждого.',
    tz_intro:'Смотрите текущее время в реальном времени в 6 крупных городах (Эр-Рияд, Дубай, Лондон, Нью-Йорк, Токио, Сидней) или конвертируйте время между любыми двумя часовыми поясами из списка 20 городов мира.',
    word_intro:'Вставьте текст, и статистика по словам, символам и предложениям появится мгновенно. Полезно для писателей, студентов и блогеров, которым нужно отслеживать лимиты слов в статьях, сообщениях или научных работах.',
    pass_intro:'Этот инструмент использует встроенный в браузер Web Crypto API для генерации настоящей криптографической случайности — пароли никогда не сохраняются и не отправляются на сервер. Выберите длину и типы символов, затем нажмите, чтобы мгновенно скопировать.',
    ic_intro:'Сжимайте изображение прямо в браузере без загрузки на сервер. Вся обработка происходит на вашем устройстве, что гарантирует полную конфиденциальность. Поддерживаются JPG, PNG и WebP — экономия может достигать 90% в зависимости от изображения и настроек, с полным контролем над уровнем качества.',
    qr_intro:'Создайте QR-код для любой ссылки или текста за секунды. Скачайте его в виде PNG высокого качества. Идеально подходит для ссылок на сайты, номеров WhatsApp, email-адресов и визитных карточек.',
    ci_intro:'Сложные проценты основаны на принципе «проценты приносят проценты» — доход от инвестиций добавляется к основной сумме и, в свою очередь, приносит новый доход. Этот накопительный эффект делает разницу между ранним и поздним началом накоплений огромной в долгосрочной перспективе. Введите сумму, процентную ставку и срок, чтобы увидеть силу сложных процентов.',
    unit_intro:'Поддерживает три типа конвертации: длина (метр, километр, фут, дюйм, миля), вес (килограмм, фунт, грамм, тонна) и температура (Цельсий, Фаренгейт, Кельвин). Конвертация происходит мгновенно во время ввода.',
    hijri_intro:'Этот конвертер переводит даты между исламским (хиджра) лунным календарём и григорианским солнечным календарём с использованием табличного алгоритма календаря хиджры. Обычно используется для определения дат исламских событий, таких как Рамадан и Ид аль-Адха, и широко применяется в странах Персидского залива. Результаты могут отличаться на 1–2 дня от официальных календарей, основанных на наблюдении луны.',
    dd_intro:'Бесплатный инструмент для расчёта точной разницы между двумя датами в днях, неделях, месяцах, годах и приблизительных рабочих днях. Полезен для расчёта сроков контрактов, периодов отпуска и количества дней, оставшихся до предстоящего события.',
};

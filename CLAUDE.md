...
- Not yet done: the hub-card labels/descriptions for these 14 games on `ae/index.html`/`us/index.html`/`uk/index.html` (the English-language country pages) are still Arabic-only — this was the original complaint that started the whole translation project, and is still open. The in-page quiz UI (this section) was tackled first.

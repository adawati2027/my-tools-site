...
13. 💡 اختراعات واكتشافات (`inventions-quiz/`) — **built**, 103 questions. Contested "who invented X" claims (telephone, light bulb, radio, TV) deliberately reframed around uncontested facts (first patent, first public demo) rather than asserting sole credit.

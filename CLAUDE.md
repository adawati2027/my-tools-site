...
14. 🎭 ثقافي (`culture-quiz/`) — **built**, 138 questions. World + Arab literature/art/cinema; avoided quoting copyrighted text at length and politically/religiously sensitive framing.

**Total: 1,763 questions across 14 games**, all cross-linked to each other via the "أدوات الأردن الأخرى" section, all listed on `jo/index.html`'s hub (both the legacy games section and the tabbed challenges grid) and in `sitemap.xml`.

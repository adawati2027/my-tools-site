...
- **Logo quiz at 212/~400 target questions** — this is an accepted, realistic ceiling (see the file), not a shortfall to keep chasing without new sourcing methods. See [docs/history/quiz-games.md](docs/history/quiz-games.md).

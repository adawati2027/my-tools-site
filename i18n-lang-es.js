...
window.T.es = {
    ...
    back:'← Volver al inicio', footer_about:'Sobre nosotros', footer_contact:'Contacto', footer_privacy:'Privacidad', footer_terms:'Términos',
...
cty_global:'Global', cty_om:'Omán', cty_ae:'Emiratos Árabes Unidos', cty_sa:'Arabia Saudita', cty_us:'Estados Unidos', cty_uk:'Reino Unido', cty_jo:'Jordania', cty_in:'India', cty_pk:'Pakistán', cty_bd:'Bangladés', cty_eg:'Egipto', cty_ph:'Filipinas', badge_privacy_full:'La mayoría de las herramientas funcionan localmente en tu navegador', badge_count_full:'40+ herramientas y guías', export_img_btn:'📸 Exportar como imagen',
    ...
    discount_intro:'Herramienta gratuita con dos modos: calcular un porcentaje de un número, o calcular el precio tras un descuento determinado. Útil para compras, ofertas y comparar precios en supermercados y tiendas online.',
    sal_intro:'Calcula tu salario neto en Omán al instante — introduce tu salario base y los complementos, y las contribuciones al SPF se calculan automáticamente. En 2026 no se aplica impuesto sobre la renta personal a los salarios (ley PIT promulgada en 2025, aplicación desde 2028) — la única deducción para los omaníes es el 8% del SPF.',
    vat_intro:'El IVA (Impuesto sobre el Valor Añadido) se aplica en los países del Golfo. Omán implementó un IVA del 5% en abril de 2021 sobre la mayoría de bienes y servicios. Esta calculadora admite 6 países del CCG y te permite añadir el IVA a cualquier importe o extraerlo de él.',
    tip_intro:'Calcula la propina adecuada y divide la cuenta a partes iguales entre cualquier número de personas. Mueve el control deslizante para elegir un porcentaje de propina (0 % a 30 %) e introduce el número de personas para obtener al instante la parte de cada una.',
    tz_intro:'Consulta la hora actual en directo en 6 ciudades principales (Riad, Dubái, Londres, Nueva York, Tokio, Sídney) o convierte cualquier hora entre dos zonas de una lista de 20 ciudades del mundo.',
    word_intro:'Pega tu texto y aparecerán al instante las estadísticas de palabras, caracteres y frases. Útil para escritores, estudiantes y blogueros que necesitan controlar los límites de palabras en artículos, mensajes o trabajos de investigación.',
    pass_intro:'Esta herramienta utiliza la API Web Crypto integrada en el navegador para generar aleatoriedad criptográfica real — las contraseñas nunca se almacenan ni se envían a ningún servidor. Elige la longitud y los tipos de caracteres, y haz clic para copiar al instante.',
    ic_intro:'Comprime tu imagen directamente en el navegador sin subirla a ningún servidor. Todo el procesamiento ocurre en tu dispositivo, garantizando privacidad total. Compatible con JPG, PNG y WebP — el ahorro puede llegar al 90 % según la imagen y los ajustes, con control total sobre el nivel de calidad.',
    qr_intro:'Genera un código QR para cualquier enlace o texto en segundos. Descárgalo en PNG de alta calidad. Ideal para enlaces web, números de WhatsApp, direcciones de correo y tarjetas de visita.',
    ci_intro:'El interés compuesto se basa en el principio de que "los intereses generan intereses" — las ganancias de tu inversión se suman al capital y a su vez generan nuevas ganancias. Este efecto acumulativo hace que la diferencia entre ahorrar pronto o tarde sea enorme a largo plazo. Introduce tu importe, la tasa de interés y la duración para ver el poder del interés compuesto.',
    unit_intro:'Admite tres tipos de conversión: longitud (metro, kilómetro, pie, pulgada, milla), peso (kilogramo, libra, gramo, tonelada) y temperatura (Celsius, Fahrenheit, Kelvin). La conversión es instantánea mientras escribes.',
    hijri_intro:'Este conversor permite pasar del calendario islámico (hijri) lunar al calendario gregoriano solar y viceversa, mediante un algoritmo tabular del calendario hijri. Se usa habitualmente para encontrar fechas de ocasiones islámicas como el Ramadán y el Eid al-Adha, y es ampliamente utilizado en los estados del Golfo. Los resultados pueden diferir en 1-2 días respecto a los calendarios oficiales basados en la observación lunar.',
    dd_intro:'Herramienta gratuita para calcular la diferencia exacta entre dos fechas en días, semanas, meses, años y días laborables aproximados. Útil para calcular la duración de contratos, periodos de vacaciones y los días que faltan para un evento próximo.',
};
